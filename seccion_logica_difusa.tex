...
La Figura~\ref{fig:mamdani_flujo} resume este flujo de información para el caso específico del problema de congestión vehicular considerado en esta tesis.
...
En el contexto de esta tesis, estos resultados justifican la elección de un sistema de inferencia Mamdani para clasificar el grado de congestión urbano a partir de variables macroscópicas, proporcionando una salida interpretable (leve, moderada, severa) que puede integrarse de forma natural con los módulos de optimización y control semafórico desarrollados en capítulos posteriores.