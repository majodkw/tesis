...
Durante la ejecución de las pruebas se identificaron tres desafíos técnicos relevantes
para un despliegue de producción: la dependencia de Pinata como nodo IPFS gestionado por
terceros, la variabilidad en los tiempos de minado de la red BlockDAG pública de pruebas,
y un incidente de configuración de endpoints (redirecciones HTTP~307 por la ausencia de
la barra final en las rutas de subida y descarga) que motivó incorporar validación previa
del entorno al protocolo de prueba. El Capítulo~\ref{chp:conclusion} desarrolla estas
limitaciones junto con las del control semafórico y las líneas de trabajo futuro que se
desprenden de ellas.
