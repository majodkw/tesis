...
corridas del protocolo de prueba. A esto se suma que la evaluación del control semafórico se
realizó exclusivamente en simulación (SUMO) sobre una única red vial urbana, la del microcentro
de San Lorenzo, por lo que la generalización a otras topologías de red y a condiciones de
tráfico de campo permanece por validar.
